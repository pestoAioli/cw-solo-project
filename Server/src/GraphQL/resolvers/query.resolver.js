...
exports.getDirections = async (_, args) => {
  ...
  const endURL =
    "/json?maxAlternatives=2&instructionsType=coded&routeRepresentation=polyline&routeType=thrilling&traffic=true&avoid=unpavedRoads&travelMode=car&hilliness=high&windingness=normal&key=" +
    process.env.TOMTOM_API;
